        ...
        <div label="Vidad" className="tabular">
          <div className="information">
            ...
            <p>
              ...
              student. I enjoy programming, biking, volleyball, and basketball.
              ...
              <div className="Works">
                <div className="work">
                  <h6>LEDS CRUD App</h6>
                  <p>
                    CRUD Application using VB.Net for a printing shop in Ilocos
                    Norte Called LEDS Ilocos.
                  </p>
                  <a
                ...
                <div className="work">
                  ...
                  <p>
                    A Web App for Voters to check their respective precinct and
                    schedule when they want to vote. This was a Group Project
                  </p>
                  <a
                ...
                <div className="work">
                  ...
                  <p>
                    A simple Calculator that can do stack calculation. (This was
                    made during my 9th grade)
                  </p>
                  <a
                    href="https://github.com/cs192-VotersPortal/voter-portal"
                    target="_blank"
